        ...
        <Dialog onClose={handleClose} open={open}>
            <List sx={{pt: 0}}>
                <ListItem onClick={() => handleListItemClick('addAccount')}>
                    <NavLink to="/m/profile" style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
                        <ListItemAvatar>
                            <Avatar>
                                <AccountCircleIcon/>
                            </Avatar>
                ...
                <ListItem onClick={() => handleListItemClick('addAccount')}>
                    <NavLink to="/m/order" style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
                        <ListItemAvatar>
                            <Avatar>
                                <ReceiptLongIcon/>
                            </Avatar>
                ...
                <ListItem onClick={() => handleListItemClick('addAccount')}>
                    ...
                    }} to="/sign-in" style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
                        <ListItemAvatar>
                            <Avatar>
                                <ExitToAppIcon/>
                            </Avatar>
