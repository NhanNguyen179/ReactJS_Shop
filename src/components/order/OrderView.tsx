...
import {Avatar, Button, CircularProgress, Pagination} from "@mui/material";
...
export default function OrderView(child:any) {
    ...
    return (
        <Box style={{display:'flex',justifyContent:'center',alignItems:"center",minHeight:300,backgroundColor:"white"}}>
            {
